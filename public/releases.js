...
function renderReleases(releases) {
    ...
    releases.forEach(release => {
        ...
        // If no specific sections were found but there is body text (e.g. v0.1.0 description), 
        // we might want to display it as a general note.
        // However, the user specifically asked for the format with Added/Changed/Fixed.
        // For v0.1.0, it has "First Release of Easy Scanlate" at the top.
